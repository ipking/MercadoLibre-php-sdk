...
class MarketplaceItemsPutClient extends BaseClient {
	
	protected $method = self::METHOD_PUT;
	
	public function __construct(MarketplaceItemsPutParameter $parameter) {
	...
	public function send() {
		...
		return new MarketplaceItemsPutResponse(
